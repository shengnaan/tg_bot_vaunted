...
async def menu(message: Message) -> None:
    await message.answer(
        ...
        "2️⃣ /praise - это мастхев лаудика, тыкай и он напомнит тебе кто тут самый мили цветочек.\n\n"
        "3️⃣ /meow - в простонародье мяу или мээээу, Лаудик закинет тебе китикета. Будет он мили, игривый или смешной он решит сам.\n\n"
        "4️⃣ /send - отправить смс(очку) папочке (пете п.), кидай че хочешь, хоть смайлик, хоть фильм загрузи.\n\n"
        "балдей малыха"
    )
